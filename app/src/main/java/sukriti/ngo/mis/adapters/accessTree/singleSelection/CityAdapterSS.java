...
public class CityAdapterSS extends RecyclerView.Adapter<CityAdapterSS.MyViewHolder> {
    ...
    public CityAdapterSS(Context mCtx, District mData, int stateIndex, int districtIndex, TreeInteractionListener mTreeInteractionListener) {
        this.mData = mData;
        this.mContext = mCtx;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        ComplexAdapterSS mAdapter = new ComplexAdapterSS(mContext, mData.getCities().get(position),stateIndex,districtIndex,position,mTreeInteractionListener);
