...
public class DistrictAdapterSS extends RecyclerView.Adapter<DistrictAdapterSS.MyViewHolder> {
    ...
    public DistrictAdapterSS(Context mCtx, State mData, int stateIndex, TreeInteractionListener mTreeInteractionListener) {
        this.mData = mData;
        this.mContext = mCtx;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        CityAdapterSS mAdapter = new CityAdapterSS(mContext, mData.getDistricts().get(position),stateIndex,position,mTreeInteractionListener);
