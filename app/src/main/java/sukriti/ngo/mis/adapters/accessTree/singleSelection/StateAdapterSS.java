...
public class StateAdapterSS extends RecyclerView.Adapter<StateAdapterSS.MyViewHolder> {
    ...
    public StateAdapterSS(Context mCtx, Country mData, TreeInteractionListener mTreeInteractionListener) {
        this.mData = mData;
        this.mContext = mCtx;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        DistrictAdapterSS mAdapter = new DistrictAdapterSS(mContext, mData.getStates().get(position),position,mTreeInteractionListener);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            recursive.setVisibility(View.GONE);
        }
    }
