...
import static sukriti.ngo.mis.AWSConfig.*;
...
public class AuthenticationClient {
    ...
    private static AuthenticationClient appHelper;
    ...
    public static void init(Context context) {
        ...
        if (appHelper == null) {
            appHelper = new AuthenticationClient();
        }
...
//            */
    ...
    public static void setCurrSession(CognitoUserSession session) {
        Log.i("_loginFlow", "Setting current session");
        currSession = session;
        Log.i("_loginFlow", "Current session set");
    }
    ...
    public static List<ItemToDisplay> getUserAttributesForFirstLogInCheck() {
        return firstTimeLogInDetails;
    }
    ...
    public static void setUserAttributeForDisplayFirstLogIn(Map<String, String> currAttributes, List<String> requiredAttributes) {
        ...
        Log.i("_firstLo!","currAttributes:"+currAttributes.size());
        Log.i("_firstLo!","requiredAttributes:"+requiredAttributes.size());
    }
    ...
    private static void setData() {
        ...
        attributeDisplaySeq.add("gender");
        ...
        signUpFieldsC2O.put("Gender", "gender");
        ...
        signUpFieldsO2C.put("gender", "Gender");
