...
import sukriti.ngo.mis.ui.administration.adapter.define_access.CityAdapter;
...
public class DistrictAdapterST extends RecyclerView.Adapter<DistrictAdapterST.MyViewHolder> {
    ...
    public DistrictAdapterST(Context mCtx, State mData, int stateIndex, TreeInteractionListener mTreeInteractionListener) {
        this.mData = mData;
        this.mContext = mCtx;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        CityAdapterST mAdapter = new CityAdapterST(mContext, mData.getDistricts().get(position),stateIndex,position,mTreeInteractionListener);
