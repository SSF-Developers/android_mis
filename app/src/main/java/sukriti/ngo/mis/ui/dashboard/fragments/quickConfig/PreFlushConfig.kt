...
class PreFlushConfig : Fragment() {
    ...
    companion object {
        private var INSTANCE: PreFlushConfig? = null

        fun getInstance(): PreFlushConfig {
            return INSTANCE
                ?: PreFlushConfig()
        }
    }
    ...
    private fun init() {
        ...
        binding.enabledCont.label.text = "Automatic Pre-Flush"
        binding.onCont.label.text = "Activation Delay"
        binding.offCont.label.text = "Flush Duration"
        binding.description.text = getString(R.string.description_pre_flush_config)

        binding.onCont.root.visibility = View.INVISIBLE
        binding.offCont.root.visibility = View.INVISIBLE
        ...
        binding.submit.setOnClickListener(View.OnClickListener {
            ...
            if(isSubmissionValidated()){
                ...
                for(index  in 0 until scopeSelection.length()){
                    ...
                    payloadJO.put("Autopreflush", selection)
...
//                    payloadJO.put("Floorcleandurationtimer", binding.onCont.time.editText?.text.toString())
                    ...
                    var payloadInfoJO = CommunicationHelper.getGenericConfigInfo("CMS/PRE-FLUSH",
