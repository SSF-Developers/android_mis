...
class BwtComparisionChartClient(ctx: Context, graph:BarChart, data: UsageReportData) {
    var barChart: BarChart = graph
    var chartData = data.bwtCollectionComparison
    var context = ctx
    ...
    init {
        ...
        Log.i("reportLambda", "upiCollectionComparison: "+ Gson().toJson(data.upiCollectionComparison))
        setData()
    }
