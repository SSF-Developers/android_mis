...
public class DistrictAdapterCS extends RecyclerView.Adapter<DistrictAdapterCS.MyViewHolder> {
    ...
    public DistrictAdapterCS(Context mCtx, State mData, int stateIndex, TreeInteractionListener mTreeInteractionListener) {
        this.mData = mData;
        this.mContext = mCtx;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.title.setTextAppearance(mContext, R.style.AccessTree_District_SM);

        CityAdapterCS mAdapter = new CityAdapterCS(mContext, mData.getDistricts().get(position),stateIndex,position,mTreeInteractionListener);
...
//            setRecursive(holder,1,position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.i("accessLamda", "district getRecursive: "+mData.getDistricts().get(position).getRecursive());
                Log.i("accessLamda", "district getCities: "+!mData.getDistricts().get(position).getCities().isEmpty());
...
//                mTreeInteractionListener.onSelectionChange(AdministrationViewModel.TREE_NODE_DISTRICT, new TreeEdge(stateIndex,position),1);
//            }
//        });
