...
public class CityAdapterRO extends RecyclerView.Adapter<CityAdapterRO.MyViewHolder> {
    ...
    public CityAdapterRO(Context mCtx, District mData, int stateIndex, int districtIndex, TreeInteractionListener mTreeInteractionListener) {
        this.mData = mData;
        this.mContext = mCtx;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        if(mData.getCities().get(position).getComplexes()==null ||
                mData.getCities().get(position).getComplexes().isEmpty())
        ...
        if(mData.getCities().get(position).getRecursive()==1) {
            ...
            ComplexAdapterRO mAdapter = new ComplexAdapterRO(mContext, mData.getCities().get(position),stateIndex,districtIndex,position,mTreeInteractionListener);
        ...
        holder.title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mData.getCities().get(position).getRecursive()==0 && !mData.getCities().get(position).getComplexes().isEmpty()){
