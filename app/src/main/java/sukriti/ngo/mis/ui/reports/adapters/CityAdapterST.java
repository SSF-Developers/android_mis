...
import sukriti.ngo.mis.ui.administration.adapter.define_access.ComplexAdapter;
...
public class CityAdapterST extends RecyclerView.Adapter<CityAdapterST.MyViewHolder> {
    ...
    public CityAdapterST(Context mCtx, District mData, int stateIndex, int districtIndex, TreeInteractionListener mTreeInteractionListener) {
        this.mData = mData;
        this.mContext = mCtx;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        ComplexAdapterST mAdapter = new ComplexAdapterST(mContext, mData.getCities().get(position),stateIndex,districtIndex,position,mTreeInteractionListener);
