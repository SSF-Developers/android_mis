...
public class PropertiesListAdapterLA extends RecyclerView.Adapter<PropertiesListAdapterLA.MyViewHolder> {
    ...
    public PropertiesListAdapterLA(Context mCtx, List<PropertyNameValueData> mData) {
        this.mData = mData;
        this.mContext = mCtx;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;
        if(viewType == 0 )
            view = LayoutInflater.from (parent.getContext ()).inflate (R.layout.element_cabin_row,parent,false);
        else
            view = LayoutInflater.from (parent.getContext ()).inflate (R.layout.element_cabin_row,parent,false);
