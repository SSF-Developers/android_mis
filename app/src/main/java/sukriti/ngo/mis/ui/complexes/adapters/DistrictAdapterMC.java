...
public class DistrictAdapterMC extends RecyclerView.Adapter<DistrictAdapterMC.MyViewHolder> {
    ...
    public DistrictAdapterMC(Context mCtx, State mData, int stateIndex, TreeInteractionListener mTreeInteractionListener, AdministrationViewModel viewModel) {
        this.mData = mData;
        this.mContext = mCtx;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        CityAdapterMC mAdapter = new CityAdapterMC(mContext, mData.getDistricts().get(position),stateIndex,position,mTreeInteractionListener,viewModel);
