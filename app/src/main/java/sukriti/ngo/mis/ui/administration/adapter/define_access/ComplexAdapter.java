...
public class ComplexAdapter extends RecyclerView.Adapter<ComplexAdapter.MyViewHolder> {
    ...
    public ComplexAdapter(Context mCtx, City mData,int stateIndex,int districtIndex,int cityIndex,TreeInteractionListener mTreeInteractionListener, AdministrationViewModel viewModel) {
        this.mData = mData;
        this.mContext = mCtx;
