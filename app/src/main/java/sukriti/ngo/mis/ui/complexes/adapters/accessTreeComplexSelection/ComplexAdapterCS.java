...
public class ComplexAdapterCS extends RecyclerView.Adapter<ComplexAdapterCS.MyViewHolder> {
    ...
    public ComplexAdapterCS(Context mCtx, City mData, int stateIndex, int districtIndex, int cityIndex, TreeInteractionListener mTreeInteractionListener) {
        this.mData = mData;
        this.mContext = mCtx;
...
//        });
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.i("accessLamda", "Complex");


                mTreeInteractionListener.onSelectionChange(AdministrationViewModel.TREE_NODE_COMPLEX, new TreeEdge(stateIndex,districtIndex,cityIndex,position),1);
            }
        });
