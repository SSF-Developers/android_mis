...
class FullFlushConfig : Fragment() {
    ...
    companion object {
        private var INSTANCE: FullFlushConfig? = null

        fun getInstance(): FullFlushConfig {
            return INSTANCE
                ?: FullFlushConfig()
        }
    }
    ...
    private fun init() {
        ...
        binding.enabledCont.label.text = "Automatic Full-Flush"
        ...
        binding.submit.setOnClickListener(View.OnClickListener {
            ...
            if(isSubmissionValidated()){
                ...
                for(index  in 0 until scopeSelection.length()){
                    ...
                    payloadJO.put("Autofullflushenabled", selection)
                    payloadJO.put("fullflushdurationtimer", binding.offCont.time.editText?.text.toString())
                    payloadJO.put("fullflushactivationtimer", binding.onCont.time.editText?.text.toString())
                    ...
                    var payloadInfoJO = CommunicationHelper.getGenericConfigInfo("CMS/FULL-FLUSH",
