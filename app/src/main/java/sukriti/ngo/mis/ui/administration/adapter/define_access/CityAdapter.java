...
public class CityAdapter extends RecyclerView.Adapter<CityAdapter.MyViewHolder> {
    ...
    public CityAdapter(Context mCtx, District mData,int stateIndex,int districtIndex,TreeInteractionListener mTreeInteractionListener,AdministrationViewModel viewModel) {
        this.mData = mData;
        this.mContext = mCtx;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        ComplexAdapter mAdapter = new ComplexAdapter(mContext, mData.getCities().get(position),stateIndex,districtIndex,position,mTreeInteractionListener,viewModel);
