...
public class ComplexAdapterMC extends RecyclerView.Adapter<ComplexAdapterMC.MyViewHolder> {
    ...
    public ComplexAdapterMC(Context mCtx, City mData, int stateIndex, int districtIndex, int cityIndex, TreeInteractionListener mTreeInteractionListener, AdministrationViewModel viewModel) {
        this.mData = mData;
        this.mContext = mCtx;
