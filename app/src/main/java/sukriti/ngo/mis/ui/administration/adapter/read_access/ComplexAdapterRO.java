...
public class ComplexAdapterRO extends RecyclerView.Adapter<ComplexAdapterRO.MyViewHolder> {
    ...
    public ComplexAdapterRO(Context mCtx, City mData, int stateIndex, int districtIndex, int cityIndex, TreeInteractionListener mTreeInteractionListener) {
        this.mData = mData;
        this.mContext = mCtx;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        //if(mData.getComplexes().get(position).getIsSelected()==1)
        {
            ...
            setSelection(holder,true,position);
    ...
    private void setSelection(MyViewHolder holder, boolean status, int index){
        if (status) {
